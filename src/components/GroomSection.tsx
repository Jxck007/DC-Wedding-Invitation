...
export const GroomSection: FC = () => {
  ...
  useMobileReveal(sectionRef, ['.groom-section__content > *', '.groom-section__image-wrapper']);
  ...
  return (
    <section ref={sectionRef} className="groom-section" aria-label={t('groom', 'title')}>
      <div className="groom-section__container">
        ...
        {/* Image */}
        <div className="groom-section__image-wrapper wedding-artwork wedding-artwork--groom">
