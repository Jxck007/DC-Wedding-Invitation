...
export const VenueSection: FC = () => {
  ...
  useMobileReveal(sectionRef, ['.venue-section__content > .eyebrow', '.venue-section__venue-name', '.venue-section__address--mobile', '.venue-section__shared', '.venue-actions', '.venue-section__map'], false, 'top 90%', true);
  useEffect(() => {
    ...
    <section ref={sectionRef} id="venue" className="venue-section" aria-label={t('venue', 'title')}>
      <div className="venue-section__container">
        <div className="venue-section__content">
          ...
          <address className={`venue-section__address venue-section__address--mobile ${isTamil ? 'venue-section__address--ta' : ''}`}>{WEDDING_CONFIG.venue.address[language]}</address>
        ...
        <div className="venue-section__map">
          ...
          <address className={`venue-section__address venue-section__address--desktop ${isTamil ? 'venue-section__address--ta' : ''}`}>{WEDDING_CONFIG.venue.address[language]}</address>
        </div>
      </div>
    </section>
  );
