...
export const VenueSection: FC = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => gsap.from('.venue-section__content, .venue-section__map', {
